...
*/
const Token_1 = __importDefault(require("illuminate/utils/Token"));
const t = Token_1.default.create("Samer LTD", 100);
console.log(t);
setTimeout(() => {
    console.log(Token_1.default.isValid("Samer LTD", "dj"));
}, 50);
