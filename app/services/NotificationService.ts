...
export default class NotificationService {
  async send(notifiables: UserDocument | UserDocument[], notification: Notification) {
  ...
  async sendOne(notifiable: UserDocument, notification: Notification) {
  ...
  async sendOneVia(channel: NotificationChannel, notifiable: UserDocument, notification: Notification) {
